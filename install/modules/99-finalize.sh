...
ReadWritePaths=/etc/forgeos /var/log/forgeos /opt/forgeos /srv -/etc/samba -/etc/nginx -/etc/fail2ban -/etc/letsencrypt -/var/log/letsencrypt -/var/lib/letsencrypt -/etc/exports.d -/etc/wireguard -/etc/rear -/etc/ufw -/etc/crowdsec -/etc/snapper -/run
